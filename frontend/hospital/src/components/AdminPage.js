      ...
      .then((response) => {
        if (response.ok) {
          const updatedDoctors = doctors.map((doctor) =>
            doctor.id === user.id ? updatedUser : doctor
          );
                  ...
                  <TableRow key={doctor.id}>
                    ...
                    <TableCell style={{ width: '33%' }}>
                      ...
                      <Button
                        ...
                        onClick={() => handleEnable(doctor)}
                        disabled={doctor.status === 'Active'} // Disable the button if status is 'Active'
                      >
                        Enable
                      </Button>
                      <Button
                        ...
                        disabled={doctor.status === 'Inactive'} // Disable the button if status is 'Inactive'
                      >
                        Disable
                      </Button>
                    ...
                    <TableCell style={{ width: '33%' }}>
                      ...
                      <Box display="flex" justifyContent="center">
                        <Button
                          ...
                          color="success"
                          style={{ marginRight: '10px' }}
                          onClick={() => handleEnable(patient)}
                          disabled={patient.status === 'Active'} // Disable the button if status is 'Active'
                        >
                          Enable
                        </Button>
                        <Button
                          ...
                          color="secondary"
                          style={{ marginRight: '10px' }}
                          onClick={() => handleDisable(patient)}
                          disabled={patient.status === 'Inactive'} // Disable the button if status is 'Inactive'
                        >
                          Disable
                        </Button>
