...
namespace SanthuSchool.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            var user = await _dbContext.Register.FirstOrDefaultAsync(u => u.Email == model.Email);
            ...
            {
                return BadRequest("The user account is inactive. Please contact the administrator.");
            }
        ...
        private bool VerifyPassword(string savedPassword, string enteredPassword)
        {
        ...
        public IActionResult DisableUser(int userId)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, "An error occurred while disabling the user account.");
            }
        }
